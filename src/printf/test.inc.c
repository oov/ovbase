...
static void test1(void) {
  ...
  TEST_CHECK(ov_snprintf(NULL, 0, NULL, TT("hello%04d%s."), 20, TT("world")) == 15);
  TEST_CHECK(ov_snprintf(buf, 10, NULL, TT("hello%04d%s."), 20, TT("world")) == 15);
  TEST_CHECK(ov_snprintf(buf, bufsize, NULL, TT("hello%04d%s."), 20, TT("world")) == 15);
...
static void test_printf_order_extension(void) {
  ...
  TEST_CHECK(ov_snprintf(buf, bufsize, NULL, TT("%3$s%2$04d%1$s."), TT("world"), 20, TT("hello")) == 15);
  TEST_CHECK(STRCMP(TT("hello0020world."), buf) == 0);
  TEST_CHECK(ov_snprintf(buf, bufsize, NULL, TT("%3$s%2$04d."), TT("world"), 20, TT("hello")) == 0);
  TEST_CHECK(ov_snprintf(buf, bufsize, TT("%3$s%2$04d%1$s."), TT("%3$s%2$04d."), TT("world"), 20, TT("hello")) == 10);
