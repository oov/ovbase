...
#define OV_ARRAY_GROW(aptrptr, newcap, errptr)                                                                         \
  ov_array_grow((void **)(aptrptr), sizeof(**aptrptr), (size_t)(newcap), (errptr)MEM_FILEPOS_VALUES)
...
#define OV_ARRAY_PUSH(aptrptr, item, err)                                                                              \
  (ov_array_prepare_for_push((void **)(aptrptr), sizeof(**aptrptr), (err)MEM_FILEPOS_VALUES)                           \
...
#define OV_BITARRAY_ALLOC(baptrptr, len, errptr)                                                                       \
  ov_bitarray_alloc((baptrptr), (size_t)(len), (errptr)MEM_FILEPOS_VALUES)
...
#define OV_BITARRAY_GROW(baptrptr, newcap, errptr)                                                                     \
  ov_bitarray_grow((baptrptr), (size_t)(newcap), (errptr)MEM_FILEPOS_VALUES)
