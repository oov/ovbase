...
#  define SOURCE_CODE_FILE_NAME (ovbase_find_file_name(__FILE__))
#endif

struct ovbase_filepos {
  char const *file;
  char const *func;
  size_t line;
};
...
static inline void *ovbase_deconster_(void const *const ptr) {
#ifdef __GNUC__
...
#  define str_unmanaged_const(char_ptr)                                                                                \
    ((struct str const){.ptr = (char *)ovbase_deconster_((char_ptr)), .len = strlen((char_ptr))})
#endif // USE_STR
...
#  define wstr_unmanaged_const(wchar_ptr)                                                                              \
    ((struct wstr const){.ptr = (wchar_t *)ovbase_deconster_((wchar_ptr)), .len = wcslen((wchar_ptr))})
#endif // USE_WSTR
...
#define OVBASE_GENERIC_CASE(typ, fn)                                                                                   \
  typ:                                                                                                                 \
  fn
...
#  define sfree(struct_str_ptr)                                                                                        \
    _Generic((struct_str_ptr),                                                                                         \
             OVBASE_GENERIC_CASE(struct wstr *, wstr_free_),                                                           \
             OVBASE_GENERIC_CASE(struct wstr *const, wstr_free_),                                                      \
             OVBASE_GENERIC_CASE(struct str *, str_free_),                                                             \
             OVBASE_GENERIC_CASE(struct str *const, str_free_))((struct_str_ptr)MEM_FILEPOS_VALUES)
#  define sgrow(struct_str_ptr, cap)                                                                                   \
    _Generic((struct_str_ptr),                                                                                         \
             OVBASE_GENERIC_CASE(struct wstr *, wstr_grow_),                                                           \
             OVBASE_GENERIC_CASE(struct wstr *const, wstr_grow_),                                                      \
             OVBASE_GENERIC_CASE(struct str *, str_grow_),                                                             \
             OVBASE_GENERIC_CASE(struct str *const, str_grow_))((struct_str_ptr), (cap)MEM_FILEPOS_VALUES)
#  define scpy(struct_str_ptr, char_ptr)                                                                               \
    _Generic((struct_str_ptr),                                                                                         \
             OVBASE_GENERIC_CASE(struct wstr *, wstr_cpy_),                                                            \
             OVBASE_GENERIC_CASE(struct wstr *const, wstr_cpy_),                                                       \
             OVBASE_GENERIC_CASE(struct str *, str_cpy_),                                                              \
             OVBASE_GENERIC_CASE(struct str *const, str_cpy_))((struct_str_ptr), (char_ptr)MEM_FILEPOS_VALUES)
#  define scpym(struct_str_ptr, ...)                                                                                   \
    _Generic((struct_str_ptr),                                                                                         \
             OVBASE_GENERIC_CASE(struct wstr *, wstr_cpy_m_),                                                          \
             OVBASE_GENERIC_CASE(struct wstr *const, wstr_cpy_m_),                                                     \
             OVBASE_GENERIC_CASE(struct str *, str_cpy_m_),                                                            \
             OVBASE_GENERIC_CASE(struct str *const, str_cpy_m_))(                                                      \
        (struct_str_ptr), (void *)(void const *[]){__VA_ARGS__, NULL} MEM_FILEPOS_VALUES)
#  define sncpy(struct_str_ptr, char_ptr, size_t)                                                                      \
    _Generic((struct_str_ptr),                                                                                         \
             OVBASE_GENERIC_CASE(struct wstr *, wstr_ncpy_),                                                           \
             OVBASE_GENERIC_CASE(struct wstr *const, wstr_ncpy_),                                                      \
             OVBASE_GENERIC_CASE(struct str *, str_ncpy_),                                                             \
             OVBASE_GENERIC_CASE(struct str *const, str_ncpy_))(                                                       \
        (struct_str_ptr), (char_ptr), (size_t)MEM_FILEPOS_VALUES)
#  define scat(struct_str_ptr, char_ptr)                                                                               \
    _Generic((struct_str_ptr),                                                                                         \
             OVBASE_GENERIC_CASE(struct wstr *, wstr_cat_),                                                            \
             OVBASE_GENERIC_CASE(struct wstr *const, wstr_cat_),                                                       \
             OVBASE_GENERIC_CASE(struct str *, str_cat_),                                                              \
             OVBASE_GENERIC_CASE(struct str *const, str_cat_))((struct_str_ptr), (char_ptr)MEM_FILEPOS_VALUES)
#  define scatm(struct_str_ptr, ...)                                                                                   \
    _Generic((struct_str_ptr),                                                                                         \
             OVBASE_GENERIC_CASE(struct wstr *, wstr_cat_m_),                                                          \
             OVBASE_GENERIC_CASE(struct wstr *const, wstr_cat_m_),                                                     \
             OVBASE_GENERIC_CASE(struct str *, str_cat_m_),                                                            \
             OVBASE_GENERIC_CASE(struct str *const, str_cat_m_))(                                                      \
        (struct_str_ptr), (void *)(void const *[]){__VA_ARGS__, NULL} MEM_FILEPOS_VALUES)
#  define sncat(struct_str_ptr, char_ptr, size_t)                                                                      \
    _Generic((struct_str_ptr),                                                                                         \
             OVBASE_GENERIC_CASE(struct wstr *, wstr_ncat_),                                                           \
             OVBASE_GENERIC_CASE(struct wstr *const, wstr_ncat_),                                                      \
             OVBASE_GENERIC_CASE(struct str *, str_ncat_),                                                             \
             OVBASE_GENERIC_CASE(struct str *const, str_ncat_))(                                                       \
        (struct_str_ptr), (char_ptr), (size_t)MEM_FILEPOS_VALUES)
#  define sstr(struct_str_ptr, char_ptr, ptrdiff_t_ptr)                                                                \
    _Generic((struct_str_ptr),                                                                                         \
             OVBASE_GENERIC_CASE(struct wstr *, wstr_str_),                                                            \
             OVBASE_GENERIC_CASE(struct wstr *const, wstr_str_),                                                       \
             OVBASE_GENERIC_CASE(struct wstr const *, wstr_str_),                                                      \
             OVBASE_GENERIC_CASE(struct wstr const *const, wstr_str_),                                                 \
             OVBASE_GENERIC_CASE(struct str *, str_str_),                                                              \
             OVBASE_GENERIC_CASE(struct str *const, str_str_),                                                         \
             OVBASE_GENERIC_CASE(struct str const *, str_str_),                                                        \
             OVBASE_GENERIC_CASE(struct str const *const, str_str_))((struct_str_ptr), (char_ptr), (ptrdiff_t_ptr))
...
#  define sstr(struct_str_ptr, char_ptr, ptrdiff_t_ptr)                                                                \
    _Generic((struct_str_ptr),                                                                                         \
             OVBASE_GENERIC_CASE(struct str const *, str_str_),                                                        \
             OVBASE_GENERIC_CASE(struct str const *const, str_str_),                                                   \
             OVBASE_GENERIC_CASE(struct str *, str_str_),                                                              \
             OVBASE_GENERIC_CASE(struct str *const, str_str_))((struct_str_ptr), (char_ptr), (ptrdiff_t_ptr))
#  define sreplace_all(struct_str_ptr, char_ptr_find, char_ptr_replacement)                                            \
    _Generic((struct_str_ptr),                                                                                         \
             OVBASE_GENERIC_CASE(struct str *, str_replace_all_),                                                      \
             OVBASE_GENERIC_CASE(struct str *const, str_replace_all_))(                                                \
...
#  define sfree(struct_str_ptr)                                                                                        \
    _Generic((struct_str_ptr),                                                                                         \
             OVBASE_GENERIC_CASE(struct wstr *, wstr_free_),                                                           \
             OVBASE_GENERIC_CASE(struct wstr *const, wstr_free_))((struct_str_ptr)MEM_FILEPOS_VALUES)
#  define sgrow(struct_str_ptr, cap)                                                                                   \
    _Generic((struct_str_ptr),                                                                                         \
             OVBASE_GENERIC_CASE(struct wstr *, wstr_grow_),                                                           \
             OVBASE_GENERIC_CASE(struct wstr *const, wstr_grow_))((struct_str_ptr), (cap)MEM_FILEPOS_VALUES)
#  define scpy(struct_str_ptr, char_ptr)                                                                               \
    _Generic((struct_str_ptr),                                                                                         \
             OVBASE_GENERIC_CASE(struct wstr *, wstr_cpy_),                                                            \
             OVBASE_GENERIC_CASE(struct wstr *const, wstr_cpy_))((struct_str_ptr), (char_ptr)MEM_FILEPOS_VALUES)
#  define scpym(struct_str_ptr, ...)                                                                                   \
    _Generic((struct_str_ptr),                                                                                         \
             OVBASE_GENERIC_CASE(struct wstr *, wstr_cpy_m_),                                                          \
             OVBASE_GENERIC_CASE(struct wstr *const, wstr_cpy_m_))(                                                    \
...
#  define scat(struct_str_ptr, char_ptr)                                                                               \
    _Generic((struct_str_ptr),                                                                                         \
             OVBASE_GENERIC_CASE(struct wstr *, wstr_cat_),                                                            \
             OVBASE_GENERIC_CASE(struct wstr *const, wstr_cat_))((struct_str_ptr), (char_ptr)MEM_FILEPOS_VALUES)
#  define scatm(struct_str_ptr, ...)                                                                                   \
    _Generic((struct_str_ptr),                                                                                         \
             OVBASE_GENERIC_CASE(struct wstr *, wstr_cat_m_),                                                          \
             OVBASE_GENERIC_CASE(struct wstr *const, wstr_cat_m_))(                                                    \
...
#  define sstr(struct_str_ptr, char_ptr, ptrdiff_t_ptr)                                                                \
    _Generic((struct_str_ptr),                                                                                         \
             ...
             OVBASE_GENERIC_CASE(struct wstr const *const, wstr_str_),                                                 \
             OVBASE_GENERIC_CASE(struct wstr *, wstr_str_),                                                            \
             OVBASE_GENERIC_CASE(struct wstr *const, wstr_str_))((struct_str_ptr), (char_ptr), (ptrdiff_t_ptr))
#  define sreplace_all(struct_str_ptr, char_ptr_find, char_ptr_replacement)                                            \
    _Generic((struct_str_ptr),                                                                                         \
             OVBASE_GENERIC_CASE(struct wstr *, wstr_replace_all_),                                                    \
             OVBASE_GENERIC_CASE(struct wstr *const, wstr_replace_all_))(                                              \
...
static inline uint64_t ovbase_splitmix64(uint64_t x) {
  x = (x ^ (x >> 30)) * 0xbf58476d1ce4e5b9;
  x = (x ^ (x >> 27)) * 0x94d049bb133111eb;
  return x ^ (x >> 31);
}

static inline uint64_t ovbase_splitmix64_next(uint64_t const x) { return x + 0x9e3779b97f4a7c15; }

// https://github.com/skeeto/hash-prospector
static inline uint32_t ovbase_splitmix32(uint32_t x) {
  x = (x ^ (x >> 16)) * 0x7feb352d;
  x = (x ^ (x >> 15)) * 0x846ca68b;
  return x ^ (x >> 16);
}
